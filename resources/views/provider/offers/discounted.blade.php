...
@section('title', 'تفاصيل المنتج المخفض')

@section('content')
    <div class="app-data">
        <section class="most-requested project-details m-section">
            <div class="project-details-header">
                <h2 class="sub-header">تفاصيل المنتج المخفض</h2>
                <a href="{{ route('site.provider.offers.index') }}">رجوع للعروض</a>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="requested-card">
                            <div class="img-container">
                                <img src="{{ $product->first_image ?? asset('images/default.png') }}" alt="product">
                            </div>
