...
<section class="store-product m-section">
          <div class="main-container">
            <div class="store-product-header">
              ...
              <p>
                متجر متخصص في بيع موكابس احترافية تساعد المصممين والعلامات
                التجارية على عرض أعمالهم بشكل جذاب وسهل الاستخدام.
              </p>
              <a href="" class="main_btn" data-bs-toggle="modal" data-bs-target="#join"> مراسلة </a>
            </div>
                      ...
                      <div class="accordion-item">
                        ...
                        >
                          <div class="accordion-body">
                            <div class="main-container">
                              <div class="opinions-comment">
                                <div class="comment-card">

                                    <div class="comment-product">
                                        <div class="img-container">
                                            <img src="{{asset('site/user')}}/images/product-comment.png" alt="">
                                        </div>
                                        <p>
                                            نظام غذائى للمبتدئين
                                        </p>
                                    </div>
