...
@section(section: 'content')
     <section class="our-products">
          <div class="main-container">
            <h2 class="sub-title"> التصميم والابداع</h2>
            <p class="sub-paragraph">
               صفحة التصميم والإبداع هي مساحتك لاكتشاف قوالب جاهزة، موكابس، وملفات تساعدك تطور أفكارك وتحولها لأعمال إبداعية بسهولة.
            </p>
                    ...
                    <div class="category-details-owl owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="category-details-card">
                                <div class="card-img">
                                    <img src="{{asset('site/user')}}/images/category.png" alt="" />
                                </div>
                        ...
                        <div class="item">
                            <div class="category-details-card">
                                <div class="card-img">
                                    <img src="{{asset('site/user')}}/images/category2.png" alt="" />
                                </div>
                        ...
                        <div class="item">
                            <div class="category-details-card">
                                <div class="card-img">
                                    <img src="{{asset('site/user')}}/images/category3.png" alt="" />
                                </div>
