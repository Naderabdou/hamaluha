     ...
     <!-- out products -->
        <section class="our-products">
          <div class="main-container">
            <h2 class="sub-title">منتجاتنا</h2>
            <p class="sub-paragraph">
                استكشف مكتبتنا الرقمية المتنوعة التي تضم ملفات تعليمية، قوالب تصميم احترافية، كتب إلكترونية، ووسائل علاجية. كل ما تحتاجه في مكان واحد ليسهّل عليك التعلم، الإبداع، والعمل.
            </p>
            <div class="our-products-items">
              <a href="./category.html" class="products-item">
                <div class="item-img">
                  <img src="{{asset('site/user')}}/images/our-product1.png" alt="" />
                </div>
              ...
              <a href="./category1.html" class="products-item">
                <div class="item-img">
                  <img src="{{asset('site/user')}}/images/our-product2.png" alt="" />
                </div>
              ...
              <a href="./category3.html" class="products-item">
                <div class="item-img">
                  <img src="{{asset('site/user')}}/images/our-product3.png" alt="" />
                </div>
                <p>الكتب إلكترونية </p>
              </a>
              <!--  -->
              <a href="./category2.html" class="products-item">
                <div class="item-img">
                  <img src="{{asset('site/user')}}/images/our-product4.png" alt="" />
                </div>
                <p> الصحة والرياضة </p>
              </a>
            </div>
