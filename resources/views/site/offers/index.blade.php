...
@section('content')
    ...
    <section class="our-products">
        <div class="main-container">
            <h2 class="sub-title">{{ __('العروض على المنتجات') }}</h2>
            <p class="sub-paragraph">
                {{ $settings->{'offers_desc_' . app()->getLocale()} }}
            </p>
            {{-- <div class="offer-panner">
                <div class="offer-bg">
                    <img src="{{asset('site')}}/images/offer-bg.svg" alt="">
                </div>
                <div class="offer-paint">
                    <img src="{{asset('site')}}/images/offer-paint.svg" alt="">
                </div>
                ...
                <div class="row">
                        ...
                        <div class="panner-text">
                            ...
                            <div class="panner-actions">
                                ...
                                <div class="panner-price">
                                    ...
                                    <img src="{{asset('site')}}/images/white-ryal.svg" alt="">
                    ...
                    <div class="col-lg-6 col-md-12 h-100">
                        <div class="img-panner">
                            <img src="{{asset('site')}}/images/offer-panner.png" alt="">
                        </div>
                    </div>
                </div>
            </div> --}}
                ...
                <div class="row">
                    @forelse ($offers as $offer)
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            ...
                            <a href="{{ route('site.offers.show', $offer->id) }}" class="best-seller-card">
                                <div class="card-img">
                                    {{-- <div class="rate">
                                    <p>
                                        4.5
